...
expectError(handleCliError('', { types: { error: {} } }))
expectNotAssignable<Options>({ types: { error: {} } })
expectError(handleCliError('', { types: { other: {} } }))
expectNotAssignable<Options>({ types: { other: {} } })
